...
/*
void CardImageTest::LoadImages(HINSTANCE hInst) {
	//char* backFileName = "back.bmp\0";
	wchar_t* backFileName = L"back.bmp";
	//char* frontFileName = "3-c.bmp";
	wchar_t* frontFileName = L"3-c.bmp";

	cardBack = (HBITMAP)LoadImage(hInst, backFileName,
		IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE);
	cardFront = (HBITMAP)LoadImage(hInst, frontFileName,
		IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE);
}*/
